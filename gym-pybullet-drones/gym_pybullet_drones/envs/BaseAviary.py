...
from gym_pybullet_drones.utils.utils import get_asset_path
...
class BaseAviary(gym.Env):
    ...
    def _housekeeping(self):
        ...
        self.DRONE_IDS = np.array([p.loadURDF(get_asset_path(self.URDF),
                                              self.INIT_XYZS[i,:],
    ...
    def _parseURDFParameters(self):
        ...
        """
        URDF_TREE = etxml.parse(get_asset_path(self.URDF)).getroot()
